...
function title(){
	...
	printf "\nScript created by: Jorge Henrique Moreira Santana"
...
function main(){
	...
	https_proxy_backup=$http_proxy
	ftp_proxy_backup=$http_proxy
	...
	https_proxy=$https_proxy_backup
	ftp_proxy=$ftp_proxy_backup
}
